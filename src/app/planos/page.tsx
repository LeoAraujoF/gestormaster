        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center max-w-5xl mx-auto">
          ...
          <Card className="glass-card flex flex-col relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-slate-500/30">
            ...
            <CardFooter className="pt-6 mt-auto flex gap-2">
              ...
              >
                {isCheckoutLoading === process.env.NEXT_PUBLIC_STRIPE_PRICE_BASIC ? <Loader2 className="w-5 h-5 animate-spin" /> : <CreditCard className="w-4 h-4 mr-2" />}
                Cartão
              </Button>
              <Button 
                ...
                disabled={isCheckoutLoading !== null || isPixLoading !== null}
              >
                {isPixLoading === "Lite" ? <Loader2 className="w-5 h-5 animate-spin" /> : <QrCode className="w-4 h-4 mr-2" />}
                PIX
              </Button>
            </CardFooter>
          </Card>
          ...
          {/* PLANO PRO (DESTAQUE) */}
          <Card className="glass-card flex flex-col relative overflow-hidden border-sky-500/40 shadow-2xl shadow-sky-500/20 scale-100 md:scale-110 z-10 transition-all duration-300">
          ...
          <Card className="glass-card flex flex-col relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-amber-500/30">
            ...
            <CardFooter className="pt-6 mt-auto flex gap-2">
              <Button 
                ...
                disabled={isCheckoutLoading !== null || isPixLoading !== null}
              >
                {isCheckoutLoading === process.env.NEXT_PUBLIC_STRIPE_PRICE_PREMIUM ? <Loader2 className="w-5 h-5 animate-spin" /> : <CreditCard className="w-4 h-4 mr-2" />}
                Cartão
              </Button>
              <Button 
                className="flex-1 h-12 bg-emerald-500 hover:bg-emerald-600 text-white" 
                ...
                disabled={isCheckoutLoading !== null || isPixLoading !== null}
              >
                {isPixLoading === "Plus" ? <Loader2 className="w-5 h-5 animate-spin" /> : <QrCode className="w-4 h-4 mr-2" />}
                PIX
              </Button>
            </CardFooter>
          </Card>
