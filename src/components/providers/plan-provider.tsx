...
const EMPTY: OrganizationPlanContext = { plan: 'starter', active: false, expiresAt: null, limits: { clients: 100, whatsappInstances: 1, dailyMessagesPerInstance: 80 }, capabilities: [] }
